...
`js/lesson-time-page.js`, and `js/lesson-food-page.js` are each
...
picker demonstrating am liebsten).
...
Days/Months/Seasons, Time, and Food then all shipped using
...
eight lessons pass it straight to `recordQuizResult()`
