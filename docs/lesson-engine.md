...
`js/lesson-time-page.js`, `js/lesson-food-page.js`, and
`js/lesson-drinks-page.js` are each lesson's page-specific glue: fetch
...
Days/Months/Seasons, Time, Food, and Drinks then all shipped using
...
nine lessons pass it straight to `recordQuizResult()`
