...
an A2 unit is pure content in the same shapes. Five units are live:
...
**Reflexive Verbs** (`lessons/a2-reflexive-verbs.html`) — the
`mich/dich/sich` pronoun set and accusative-vs-dative. The
